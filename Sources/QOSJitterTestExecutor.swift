...
///
typealias JitterTestExecutor = QOSJitterTestExecutor<QOSJitterTest>

///
class QOSJitterTestExecutor<T: QOSJitterTest>: QOSTestExecutorClass<T>, UDPStreamSenderDelegate {
