...
//        }
    ...
    override func mapping(map: Map) {
        ...
        telephonyNetworkCountry <- map["network_country"]
        telephonyNetworkOperator <- map["network_mcc_mnc"]
        telephonyNetworkOperatorName <- map["network_operator_name"]
        telephonyNetworkSimCountry <- map["sim_country"]
        telephonyNetworkSimOperator <- map["sim_mcc_mnc"]
        telephonyNetworkSimOperatorName <- map["sim_operator_name"]
        telephonyNetworkIsRoaming <- map["network_is_roaming"]
